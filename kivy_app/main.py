...
if __name__ == '__main__':
    ...
    #from utils import Graph,MeshLinePlot
    ...
    class CovidApp(App):
        ...
        def build(self):
            ...
            self.title_box.add_widget(self.mainbutton)
            ...
            #self.provincias_box.add_widget(self.mainbutton)
            ...
            self.layout.add_widget(self.provincias_box)
